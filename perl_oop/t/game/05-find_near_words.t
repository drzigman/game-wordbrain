...
subtest '2x2' => sub {
    ...
    inspect_found_words({
        ...
        expected_words => [
            ...
            WordBrain::Word->new({ letters => [ $let_t, $let_l, $let_k, $let_a, ] }),
            WordBrain::Word->new({ letters => [ $let_t, $let_k, ] }),
            WordBrain::Word->new({ letters => [ $let_t, $let_k, $let_a, ] }),
            WordBrain::Word->new({ letters => [ $let_t, $let_k, $let_a, $let_l, ] }),
            WordBrain::Word->new({ letters => [ $let_t, $let_k, $let_l, ] }),
            WordBrain::Word->new({ letters => [ $let_t, $let_k, $let_l, $let_a, ] }),
        ],
    });
    ...
    inspect_found_words({
        ...
        expected_words => [
            ...
            WordBrain::Word->new({ letters => [ $let_a, $let_t, $let_k, $let_l, ] }),
            ...
            WordBrain::Word->new({ letters => [ $let_a, $let_k, $let_l, $let_t, ] }),
        ],
    });
    ...
    inspect_found_words({
        ...
        expected_words => [
            ...
            WordBrain::Word->new({ letters => [ $let_l, $let_t, $let_a, $let_k, ] }),
            WordBrain::Word->new({ letters => [ $let_l, $let_t, $let_k, ] }),
            WordBrain::Word->new({ letters => [ $let_l, $let_t, $let_k, $let_a, ] }),
            ...
            WordBrain::Word->new({ letters => [ $let_l, $let_k, $let_t, ] }),
            WordBrain::Word->new({ letters => [ $let_l, $let_k, $let_t, $let_a, ] }),
            WordBrain::Word->new({ letters => [ $let_l, $let_k, $let_a, ] }),
            WordBrain::Word->new({ letters => [ $let_l, $let_k, $let_a, $let_t, ] }),
        ],
    });
    ...
    inspect_found_words({
        ...
        expected_words => [
            ...
            WordBrain::Word->new({ letters => [ $let_k, $let_t, $let_a, $let_l, ] }),
            WordBrain::Word->new({ letters => [ $let_k, $let_t, $let_l, ] }),
            WordBrain::Word->new({ letters => [ $let_k, $let_t, $let_l, $let_a, ] }),
            ...
            WordBrain::Word->new({ letters => [ $let_k, $let_l, $let_t, $let_a, ] }),
